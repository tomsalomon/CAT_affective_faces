...
def instructions():
    screen.fill((0, 0, 0))
    text1=font.render("As explained, please take the time to fill a few questionnaires",1,white)
    text2=font.render("by clicking on the bar below",1,white)
...
def display_trial(Mood,pos):
    file = os.path.join("Mood",Mood)
...
def write_header():
    ...
    sepname=subjid+"_mood_scale.txt"
...
stimlist=["sad.jpg", "angry.jpg", "anxious.jpg"]
