...
anchor = GetSecs ; % (before baseline fixation) ;
 ...
 %for runNum = runInd:runInd; % for debugging 2 runs starting with runInd
...
CenterText(w,'Please call the experimenter in order to continue to part 3', white, 0, -180);
CenterText(w,'We will now take a short break and fill some questionnaires',white, 0,-60);
Screen('Flip',w);
