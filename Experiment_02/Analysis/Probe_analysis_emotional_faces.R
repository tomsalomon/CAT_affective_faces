...
subjects_group1=c(101,103,104,106,110,112,120) # Define here your subjects' codes.
subjects_group2=c(105,107,108,111,114,116,117,119)

#exclude (group):
# 103 (1) - FA
# 115 (1) - minimal ladder

# not really excluded
# 119 - did not complete the experiment
